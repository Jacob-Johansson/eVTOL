...
#define N      4    /* number of position differences */
...
double * calc_pos (const double * inputvector)//(ddist diff, beacon_pos coordA,beacon_pos coordB,beacon_pos coordC, beacon_pos coordD)
{
  ...
  double t[N], y[N], weights[N], positions[16];
  //Beacon 1 XYZ:
  positions[0] = inputvector[3+1];
  positions[1] = inputvector[4+1];
  positions[2] = inputvector[5+1];
  //Beacon 2 XYZ:
  positions[3] = inputvector[6+1];
  positions[4] = inputvector[7+1];
  positions[5] = inputvector[8+1];
  //Beacon 3 XYZ:
  positions[6] = inputvector[9+1];
  positions[7] = inputvector[10+1];
  positions[8] = inputvector[11+1];
  //Beacon 4 XYZ:
  positions[9] = inputvector[12+1];
  positions[10] = inputvector[13+1];
  positions[11] = inputvector[14+1];
  //Beacon 5 XYZ:
  positions[12] = inputvector[15+1];
  positions[13] = inputvector[16+1];
  positions[14] = inputvector[17+1];
