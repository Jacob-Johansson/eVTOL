		...
		if len(datavars)>5:
			try:
				...
				if msg_statuscode > 0:
					...
					bpos1 = (msg_b1pos[0],msg_b1pos[1],msg_b1pos[2])
					bpos2 = (msg_b2pos[0],msg_b2pos[1],msg_b2pos[2])
					bpos3 = (msg_b3pos[0],msg_b3pos[1],msg_b3pos[2])
					bpos4 = (msg_b4pos[0],msg_b4pos[1],msg_b4pos[2])
					bpos5 = (msg_b5pos[0],msg_b5pos[1],msg_b5pos[2])
					bpos6 = (msg_b6pos[0],msg_b6pos[1],msg_b6pos[2])

					#overwrite the positions comming from the nRF board. Easier to change here....
					overwrite_bpos = True
					if overwrite_bpos:
						#---------------- office
						bpos1=(0.14,0.05,0)
						...
						bpos4=(4.6,5.15,0)
						bpos5=(2.37,0.05,2.3)
						bpos6=(0.14,3.93,2.23)

						# C2 conf room
						bpos1=(5.35,0.015,1.95)
						bpos2=(1.26,0,1.95)
						bpos3=(0,4.33,1.95)
						bpos4=(0.1,7.9,0)
						bpos5=(5.05,7.9,0.3)
