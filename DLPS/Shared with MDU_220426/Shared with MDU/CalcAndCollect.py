				...
				try:
					...
					if msg_statuscode > 0:
						...
						if max(abs(delta_dist[i][0]),abs(delta_dist[i][1]),abs(delta_dist[i][2]),abs(delta_dist[i][3]),abs(delta_dist[i][4]))<100:
							...
							estimatedPosArray.append((array_pointer.contents[0], array_pointer.contents[1], array_pointer.contents[2], msg_dDist[0],msg_dDist[1],msg_dDist[2],msg_dDist[3],msg_dDist[4], msg_b1pos[0],msg_b1pos[1],msg_b1pos[2], msg_b2pos[0], msg_b2pos[1], msg_b2pos[2], msg_b3pos[0], msg_b3pos[1], msg_b3pos[2], msg_b4pos[0], msg_b4pos[1], msg_b4pos[2], msg_b5pos[0], msg_b5pos[1], msg_b5pos[2], msg_b6pos[0], msg_b6pos[1], msg_b6pos[2]))
